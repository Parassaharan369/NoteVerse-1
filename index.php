...
?>  
    ...
    <div class="container-fluid remove-vid-marg">
      ...
      <div class="vid-content" >
        <h1 class="my-content">"Capture, Organize, and Remember: Your Notes, Simplified!"</h1>
        <small class="my-content">Let's Learn Together</small><br />
        <?php
    ...
    <div class="container-fluid bg-danger txt-banner"> <!-- Start Text Banner -->
        <div class="row bottom-banner">
          <div class="col-sm">
            <h5> <i class="fas fa-book-open mr-3"></i> 40+ Course Notes</h5>
          </div>
          <div class="col-sm">
            <h5><i class="fas fa-users mr-3"></i> Verified Notes</h5>
          </div>
          <div class="col-sm">
            <h5><i class="fas fa-keyboard mr-3"></i> Lifetime Access</h5>
          </div>
          <div class="col-sm">
            <h5><i class="fas fa-rupee-sign mr-3"></i> Give & Take Community*</h5>
          </div>
        </div>
    </div> <!-- End Text Banner -->
    ...
    <div class="container-fluid p-4" style="background-color:#E9ECEF">
      <div class="container" style="background-color:#E9ECEF">
        <div class="row text-center">
          <div class="col-sm">
            <h5>About Us</h5>
              <p>NoteVerse is a comprehensive notes website tailored to meet the academic needs of college students. With an extensive collection of course-specific notes, it serves as a one-stop resource hub to support and enhance learning.</p>
          </div>
          <div class="col-sm">
            <h5>Category</h5>
            <a class="text-dark" href="#">Data Structure & Algorithms</a><br />
            <a class="text-dark" href="#">DBMS</a><br />
            <a class="text-dark" href="#">Operating System</a><br />
            <a class="text-dark" href="#">Internship</a><br />
            <a class="text-dark" href="#">Placements</a><br />
          </div>
          <div class="col-sm">
            <h5>Contact Us</h5>
            <p>NoteVerse <br> Ph. 6265094855 </p>
          </div>
        </div>
      </div>
